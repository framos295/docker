...
mysql -h db -u root -pHuixtepec295
...
INSERT INTO `virtual_users` (`domain_id`, `password`, `email`, `quota_rule`, `status_`) VALUES ('1', '$6$nXlK9syMhFxoFWHW$DFJnkPbnq45//aSFJgDx/A7DIS5U/XpWdqm5McF5uswseutIokGKA6K9i9f/f87WHuNTIJuXQVipq6bIaiVe6/', 'admin@encoremsi.com', '10M', '1');

#Ahora agregaremos un alias: webmaster@trajearteoaxaca.com ==> otro@trajearteoaxaca.com
INSERT INTO `virtual_aliases` (`domain_id`, `source`, `destination`) VALUES ('1', 'webmaster@encoremsi.com', 'admin@encoremsi.com');
quit
